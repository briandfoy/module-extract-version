...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Module-Extract-VERSION> or 
L<MetaCPAN|https://metacpan.org/pod/Module::Extract::VERSION>:

=over 4

=item *	L<http://search.cpan.org/dist/Module-Extract-VERSION>

=item *	L<https://metacpan.org/pod/Module::Extract::VERSION>
